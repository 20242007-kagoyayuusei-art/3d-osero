    ...
    private void Update()
    {
        switch (CurrentState)
        {
            case State.Initializing:
                ...
                _stones[1][1].SetActive(true, Stone.Color.Black);
                _stones[2][1].SetActive(true, Stone.Color.White);
                _stones[1][2].SetActive(true, Stone.Color.White);
                _stones[2][2].SetActive(true, Stone.Color.Black);
                UpdateScore();
